...
const BentoCakes = () => {
  const description = "Check out My Bento Cakes baked with intense desire 🔥🔥🔥🔥🔥";
  return (
    <div className="h-screen">
      ...
      <div className="m-auto mt-5 px-2 py-5 mb-5 pb-5  w-11/12 rounded-3xl">
        <div className="overflow-auto flex flex-wrap  mb-5 pb-5 ">
          <h3 className="text-center mt-5 mb-5 pt-2 pb-2 text-yellow-500 text-bold">BENTO CAKES</h3>
